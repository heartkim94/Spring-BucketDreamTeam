...
//		pageErrorLog(req);
		...
		model.addAttribute("msg1", "throwable");
		return "common/error";
	}
	...
	public String exception(HttpServletRequest req, Model model) {
		...
		model.addAttribute("msg", "예외가 발생했습니다");
		model.addAttribute("msg1", "exception");
		return "common/error";
	}
